...
client.on('guildMemberAdd', async member => {
  await member.addRole(`727610916811571281`) //id yazan yere verilecek rol (unregistered)
...
takizaman = `<a:tamam:717296560765141075> Güvenli`}require("moment-duration-format");
 ...
 let message = member.guild.channels.find(x => x.id === `730812374872883201`) //id yazan kısma kanal id'si [orn: register-chat]
  const taki = new Discord.RichEmbed()
 .setTitle(
     "Suleyman_K - YouTube Topluluğuna Hoş Geldin"
   )
...
<a:boost:692837267567542333>**・** **Sunucumuzun Sınırsız Davet Bağlantısı** https://discord.com/CyuEEY2
