...
module.exports.run = async (bot, message, args) => {
  ...
  if (!satır) {
    return message.channel.send(':warning: Lütfen 1 satır sayısını belirtin.');
  }
  if (!sütun) {
...
exports.conf = {
  enabled: true,
  guildOnly: true,
  aliases: ['mayın-tarlası','mtarlası','m-tarlası','mayınt','mayın-t','mayınoyunu'],
  permLevel: 0
}
exports.help = {
  name: 'mayıntarlası',
  description: "mayın tarlası",
  usage: 'mayıntarlası'
}
